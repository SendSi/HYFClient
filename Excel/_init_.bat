...
for /f "delims=" %%i in ('dir /b /a-d /s %EXCEL_FOLDER%\*.xlsx') do (
	@echo %%i | findstr /i /c:"WelfareMenuConfig.xlsx" /c:"ShopGiftMenuConfig.xlsx" /c:"PokerConfig.xlsx" /c:"EightGiftConfig.xlsx" /c:"CheckInConfig.xlsx" /c:"RechargeConfig.xlsx" /c:"TodayGiftConfig.xlsx" /c:"MainUIBtnConfig.xlsx" /c:"GuideStepConfig.xlsx" > nul   
