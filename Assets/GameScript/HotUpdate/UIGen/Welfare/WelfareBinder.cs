...
namespace Welfare
{
    public class WelfareBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(LimitShop_item2.URL, typeof(LimitShop_item2));
            UIObjectFactory.SetPackageItemExtension(LimitShopPreviewView.URL, typeof(LimitShopPreviewView));
            UIObjectFactory.SetPackageItemExtension(LimitShopReplaceView.URL, typeof(LimitShopReplaceView));
            UIObjectFactory.SetPackageItemExtension(LimitShop_item3.URL, typeof(LimitShop_item3));
            UIObjectFactory.SetPackageItemExtension(LimitShopBrowseView.URL, typeof(LimitShopBrowseView));
            UIObjectFactory.SetPackageItemExtension(LimitShop_item4.URL, typeof(LimitShop_item4));
            UIObjectFactory.SetPackageItemExtension(LimitShopSellView.URL, typeof(LimitShopSellView));
            UIObjectFactory.SetPackageItemExtension(LimitShop_item5.URL, typeof(LimitShop_item5));
            UIObjectFactory.SetPackageItemExtension(LimitShopRecordView.URL, typeof(LimitShopRecordView));
            ...
            UIObjectFactory.SetPackageItemExtension(LimitShopMainView.URL, typeof(LimitShopMainView));
        }
    }
}