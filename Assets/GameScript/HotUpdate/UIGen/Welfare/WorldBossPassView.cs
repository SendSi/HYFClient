...
namespace Welfare
{
    public partial class WorldBossPassView : GComponent
    {
        public GLoader _bg;
        ...
        public static WorldBossPassView CreateInstance()
        {
            return (WorldBossPassView)UIPackage.CreateObject("Welfare", "WorldBossPassView");
        }
