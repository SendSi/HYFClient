...
namespace Activity
{
    public partial class FieldBossActPanel : GLabel
    {
        public GLoader _bg;
        ...
        public const string URL = "ui://sinorujte9l71ygcfs5";

        public static FieldBossActPanel CreateInstance()
        {
            return (FieldBossActPanel)UIPackage.CreateObject("Activity", "FieldBossActPanel");
        }
