...
namespace Activity
{
    public partial class ResourceCollectionPanel : GLabel
    {
        public GLoader _bg;
        ...
        public const string URL = "ui://sinorujtg2er1ygcfmf";

        public static ResourceCollectionPanel CreateInstance()
        {
            return (ResourceCollectionPanel)UIPackage.CreateObject("Activity", "ResourceCollectionPanel");
        }
