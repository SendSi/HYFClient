...
namespace Activity
{
    public partial class ChiefActPanel : GComponent
    {
        ...
        public const string URL = "ui://sinorujtlyph19";

        public static ChiefActPanel CreateInstance()
        {
            return (ChiefActPanel)UIPackage.CreateObject("Activity", "ChiefActPanel");
        }
