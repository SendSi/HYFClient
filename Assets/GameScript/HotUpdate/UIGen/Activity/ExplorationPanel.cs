...
namespace Activity
{
    public partial class ExplorationPanel : GLabel
    {
        public GLoader _bg;
        ...
        public const string URL = "ui://sinorujtg2er1ygcfmd";

        public static ExplorationPanel CreateInstance()
        {
            return (ExplorationPanel)UIPackage.CreateObject("Activity", "ExplorationPanel");
        }
