...
namespace DialogTip
{
    public partial class DialogPreView : GLabel
    {
        ...
        public const string URL = "ui://utp01xia9cw11ygcftg";

        public static DialogPreView CreateInstance()
        {
            return (DialogPreView)UIPackage.CreateObject("DialogTip", "DialogPreView");
        }
