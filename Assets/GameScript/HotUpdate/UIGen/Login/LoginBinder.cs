...
namespace Login
{
    public class LoginBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(head01.URL, typeof(head01));
            UIObjectFactory.SetPackageItemExtension(btn_choose.URL, typeof(btn_choose));
            UIObjectFactory.SetPackageItemExtension(clothes_btn_02.URL, typeof(clothes_btn_02));
            UIObjectFactory.SetPackageItemExtension(ServerListRemoteView.URL, typeof(ServerListRemoteView));
